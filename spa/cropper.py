...
def get_roi(
    ...
    **kwargs
    ...
    for key in ["reg_il", "reg_il_no_wing", "reg_il_dil", "closing"]:
        all_results[key] = []
    ...
    for label in set(np.unique(labels_il)).difference([0]):
        ...
        all_results["reg_il"].append(reg_il)
        ...
        if do_delete_wings:
            ...
            all_results["reg_il_no_wing"].append(reg_il)
        ...
        all_results["reg_il_dil"].append(reg_il)
    ...
    all_results["closing"].append(res)
