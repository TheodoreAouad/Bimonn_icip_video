...
class ConvMorphoAnimation(man.Scene):
    def construct(self):
        ...
        texs = [
            TemplateTex(r"X"),  # 0
            TemplateTex(r"\mathbbm{1}_{", r"X", r"}"),  # 1
            TemplateTex(r"\mathbbm{1}_{", r"X", r"}", r"\circledast", r"\mathbbm{1}_{", r"S", r"}"),  # 2
            TemplateTex(r"\mathbbm{1}_{", r"X", r"}", r"\circledast", r"\mathbbm{1}_{", r"S", r"}", r"\geq 1"),  # 3
            TemplateTex(r"X", r"\oplus", r"S"),  # 4
            TemplateTex(r"\mathbbm{1}_{", r"X", r"\oplus", r"S", r"}"),  # 5
            TemplateTex("S"),  # 6
            TemplateTex(r"\mathbbm{1}_{", "S", "}"),  # 7
            TemplateTex(r'\circledast'),  # 8
            TemplateTex(r'\oplus'),  # 9
            TemplateTex("X", r'\oplus', "S"),  # 10
            TemplateTex("X", r'\oplus', "S", "=", r"\mathbbm{1}_{", "X", "}", r"\mathbbm{1}_{", "S", "}", r"\geq", "1"),  # 11
            TemplateTex("X", r'\ominus', "S", "=", r"\mathbbm{1}_{", "X", "}", r"\circledast", r"\mathbbm{1}_{", "S", "}", r"\geq", r"\card{S}"),  # 12
            TemplateTex("="),  # 13
        ]
        ...
        # self.play(man.FadeOut(arrow_mob), man.FadeOut(array_mob2), man.FadeOut(selem_mob1), man.FadeIn(array_mob1.move_to(array_mob2)), man.TransformMatchingTex(texs[1], texs[0].next_to(array_mob2, man.DOWN)))
        ...
        # self.play(grp_dil.animate.move_to(array_mob2))
